...
- (void)testSubsequences {
    ...
    XCTAssertEqual(expectedResult,
                   [[[LongestIncreasingSubsequence alloc] init] longestIncreasingSubsequenceLength:inputArray]);
    
    NSArray *inputArray2 = @[ @0, @8, @4, @12, @2, @10, @6, @14, @1, @9, @5, @13, @3, @11, @7, @15];
    NSInteger expectedResult2 = 6;
    
    XCTAssertEqual(expectedResult2,
                   [[[LongestIncreasingSubsequence alloc] init] longestIncreasingSubsequenceLength:inputArray2]);
}
